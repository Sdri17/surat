...
?>
	...
	<div class="container">
		...
		<!-- awal formulir -->
		<form method="post" action="suratkeluar.php" class="bg-dark text-white mt-5" enctype="multipart/form-data">
			<div class="pl-4 pr-4 ">
				<h2 class="text-uppercase pt-3 pb-5 text-center"> penginputan surat keluar</h2>
					...
					<div class="form-group row">
				    	...
				    	<div class="col-9">
				      	<input type="file" class="form-control is-invalid" id="file_surat" name="file_surat">
					...
					<div class="form-group row">
					    ...
					    <div class="col-9">
						<input type="text" class="form-control" type="text" name="tujuan" required >	
				   		</div>
				   	</div>					
					...
					<div class="form-group row">
				   		<label for="inputEmail3" class="col-sm-2 col-form-label">Perihal</label>
				    		<div class="col-sm-9">
				    		<input type="text" class="form-control" id="tperihal" name="perihal" required="required">
				   		</div>
					</div>
